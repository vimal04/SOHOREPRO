...
//    }
    ...
    $all_binding_datas = $_POST['service_cutting_add']; 
    $all_binding_datas_array = explode("&", $all_binding_datas);
    $parts = array_map("trim", $all_binding_datas_array);
...
//    echo '<pre>';
//    print_r($keyValues['nob']);
//    echo '</pre>';
    
     for ($x = 1; $x <= $keyValues['nob']; $x++) {
        echo "size_dyn_".$x."=".$keyValues['size_dyn_'.$x].'</br>';;
     }
    
//     for ($x = 1; $x <= $_POST['service_cutting_add']['nob']; $x++) {
//        echo '<pre>';
//        print_r($_POST['service_cutting_add']['nob']);
//        echo '</pre><br>';
//     }
