...
if ($_POST['everything_return'] == '1') {
    ...
    <input type="hidden" name="delivery_type_option" id="delivery_type_option" value="1" />
        <div style="border: 1px #F99B3E solid;margin-bottom: 20px;padding-bottom: 20px;width: 100%;float: left;">
            <div style="width: 100%;float: left;margin-top: 10px;">
                ...
                <div style="width: 95%;float: left;margin-left: 25px;margin-top: 10px;">
                     <?php
                        $enteredFineSets        = EnteredPlotttingFineArts($_SESSION['sohorepro_companyid'],$_SESSION['sohorepro_userid']);
                        ...
                        <div style="width: 100%;float: left;">                            
                            <table border="1" style="width: 100%;">
                                ...
                                <?php
                                foreach ($enteredFineSets as $original){
                ...
                <div style="width: 95%;float: left;margin-left: 25px;margin-top: 10px;">
                    ...
                    <div style="width: 34%;float: left;"> 
                        ...
                        <div style="width: 100%;float: left;border: 1px #F99B3E solid;padding: 6px;height: 30px;border-bottom: 0px;text-align: center;">
                            <span id="asap_status_fap" class="asap_orange" onclick="return asap_fap();">ASAP</span> 
                        </div>

                        <div style="width: 100%;float: left;border: 1px #F99B3E solid;padding: 6px;height: 30px;">
                            <input class="picker_icon" value="" type="text" name="date_needed" id="date_needed_fap" style="width: 75px;" onclick="return date_reveal_return();" />
                            <input id="time_picker_icon_fap" value="" type="text" style="width: 75px;margin-left: 4px;" class="time time_picker_icon" alt="Time Picker" title="Time Picker" onclick="return show_time_return();" />
                        </div>
        ...
        <div style="float:right;">            
            <input class="all_options" value="Continue" style="cursor: pointer;font-size: 12px; padding: 1.5px; width: 135px; margin-right: 14px; -moz-border-radius: 5px; -webkit-border-radius: 5px;border:1px solid #8f8f8f;margin-top: -0px !important;" type="button" onclick="return continue_recipient_everyting_return_fap();" />
        </div>
    <?php
    ...
    <div style="border: 1px #F99B3E solid;margin-bottom: 20px;padding-bottom: 20px;width: 100%;float: left;">
            <div style="width: 100%;float: left;margin-top: 10px;">
                ...
                <div style="float: left;width: 33%;margin-left: 30px;border: 1px #F99B3E solid;margin-top: 10px;font-weight: bold;padding:3px;">Send to: 
                    <select  name="address_book_rp" id="address_book_rp_fap" style="width: 75% !important;" onchange="return show_address();">                    
                        <?php
                        $address_book = AddressBookCompanyPrimary($_SESSION['sohorepro_companyid']);
                        foreach ($address_book as $address) {
                            ?>                                                                                        
