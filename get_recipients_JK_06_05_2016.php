...
<table border="0" style="width: 120%;float: left;">
    ...
    <tr valign="top" height="30">
        <td style="font-size: 20px;font-weight: bold;">Customer Type: </td>
        <td>' . $cus_type . '</td>
    </tr>
    ...
    <tr valign="top" height="30">
        <td style="font-weight: bold;">ORIGINAL ORDER </td>
        <td>&nbsp;</td>
    </tr>';
    if ($entered_needed_sets_pdf[0]['delivery_type_option'] != '1') {
        ...
        $html_5 .= '<tr valign="top" height="30">
        <td style="font-weight: bold;">Customer Details: </td>
        <td>' . $cust_add[0]['comp_name'] . '<br>' . $cust_add[0]['comp_business_address1'] . ',<br>' . $cust_add_2 . $cust_add[0]['comp_city'] . ',&nbsp;' . $cust_add[0]['comp_state'] . '&nbsp;' . $cust_add[0]['comp_zipcode'] . '<br>' . $cust_add[0]['comp_contact_phone'] . '</td>
    </tr>
    ...
    if ($entered_needed_sets_pdf[0]['delivery_type_option'] == '1') {
        $html_5 .= '<table><tr>';
        $html_5 .= '<td><span>RECIPIENT:</td></tr>';
        $html_5 .= '<tr>';
        $html_5 .= '<td>Send to: </td>';
        $html_5 .= '</tr>';
        $html_5 .= '<tr>';
        ...
        $html_5 .= '<td>' . $cust_add[0]['comp_name'] . '<br>' . $attention_ev . $tel_eve . $cust_add[0]['comp_business_address1'] . '<br>' . $cust_add_2 . $cust_add[0]['comp_city'] . '&nbsp;' . $cust_add[0]['comp_state'] . '&nbsp;' . $cust_add[0]['comp_zipcode'] . '<br>' . $cust_add[0]['comp_contact_phone'] . '</td>';
        $html_5 .= '</tr>';
        $html_5 .= '</table>';
        ...
        if (($entered_needed_sets_final[0]['shipp_id'] != 'P1') && ($entered_needed_sets_final[0]['shipp_id'] != 'P2')) {
            ...
            $html_5 .= '<td>' . $shipp_add[0]['company_name'] . $att . $phone . '<br>' . $shipp_add[0]['address_1'] . '<br>' . $add_2 . $add_3 . $shipp_add[0]['city'] . '&nbsp;' . StateName($shipp_add[0]['state']) . '&nbsp;' . $shipp_add[0]['zip'] . '<br>' . $shipp_add[0]['phone'] . '</td>';
        } else {                    //echo $shipp_add[0]['address'];                        
            $shipp_add_p = AddressBookPickupSohoCap($entered_sets['shipp_id']);
            $html_5 .= '<td>' . $shipp_add_p[0]['address'] . '</td>';
        }
        $html_5 .= '</tr>';
        $html_5 .= '<tr>';
        $date_asap = ($entered_needed_sets_final[0]['shipp_time'] != 'ASAP') ? '&nbsp;&nbsp;&nbsp;' . $entered_needed_sets_final[0]['shipp_time'] : '';
        $html_5 .= '<td>When Needed: </span>' . $entered_needed_sets_final[0]['shipp_date'] . $date_asap . '</td>';
        $html_5 .= '</tr>';
        if ($entered_needed_sets_final[0]['spl_inc'] != '') {
            $html_5 .= '<tr>';
            $html_5 .= '<td>Special Instructions:<br>'. $entered_needed_sets_final[0]['spl_inc'].'</td>';
            $html_5 .= '</tr>';
        }
        $html_5 .= '</table>';
        $pdf->writeHTML($html_5, true, 0, true, 0);
        ...
        $html_3 .= '<table>';
        $html_3 .= '<tr><td>RECIPIENT</td></tr>';
        $html_3 .= '<tr>';
        $html_3 .= '<td>Pickup at: </td>';
        $html_3 .= '</tr>';
        $html_3 .= '<tr>';
        $html_3 .= '<td>' . $cust_add[0]['comp_name'] . '<br>' . $cust_add[0]['comp_business_address1'] . ',<br>' . $cust_add_2 . $cust_add[0]['comp_city'] . ',&nbsp;' . $cust_add[0]['comp_state'] . '&nbsp;' . $cust_add[0]['comp_zipcode'] . '<br>' . $cust_add[0]['comp_contact_phone'] . '</td>';
        $html_3 .= '</tr>';

        $html_3 .= '<tr>';
        $html_3 .= '<td>PACKING LIST: </td>';
        $html_3 .= '</tr>';
        $html_3 .= '<tr><td>';
        ...
        $html_3 .= '<table border="0" style="width: 100%;">';
        $html_3 .= '<tr bgcolor="#F99B3E">';
        $html_3 .= '<td style="width: 9%;">Option</td>';
        $html_3 .= '<td style="width: 11%;">Originals</td>';
        $html_3 .= '<td style="width: 8%;">Sets</td>';
        $html_3 .= '<td style="width: 20%;">Order Type</td>';
        $html_3 .= '<td style="width: 8%;">Size</td>';
        $html_3 .= '<td style="width: 9%;">Output</td>';
        $html_3 .= '<td style="width: 9%;">Media</td>';
        $html_3 .= '<td style="width: 9%;">Binding</td>';
        $html_3 .= '<td style="width: 9%;">Folding</td>';
        $html_3 .= '</tr>';
        foreach ($cust_original_order as $original) {
            ...
            $html_3 .= '<tr bgcolor="#ffeee1">';
            $html_3 .= '<td>' . $original['options'] . '</td>';
            $html_3 .= '<td>' . $original['origininals'] . '</td>';
            $html_3 .= '<td>' . $cust_needed_sets . '</td>';
            $html_3 .= '<td>' . $cust_order_type . '</td>';
            $html_3 .= '<td>' . $size . '</td>';
            $html_3 .= '<td style="text-transform: uppercase;">' . $output . '</td>';
            $html_3 .= '<td>' . $media . '</td>';
            $html_3 .= '<td>' . ucfirst($binding) . '</td>';
            $html_3 .= '<td>' . ucfirst($folding) . '</td>';
            $html_3 .= '</tr>';
        }
        $html_3 .= '</table>';
        $html_3 .= '</td></tr></table>';
        ...
        $html_3 .= '<table><tr>';
        $date_asap = ($entered_needed_sets_final[0]['shipp_time'] != 'ASAP') ? '&nbsp;&nbsp;&nbsp;' . $entered_needed_sets_final[0]['shipp_time'] : '';
        $html_3 .= '<td>When Needed:' . $entered_needed_sets_final[0]['shipp_date'] . $date_asap . '</td></tr>';
        if ($entered_needed_sets_final[0]['spl_inc'] != '') {
            $html_3 .= '<tr>';
            $html_3 .= '<td>Special Instructions:<br>' . $entered_needed_sets_final[0]['spl_inc'] . '</td></tr>';            
        }
        $html_3 .= '</table>';  
        $pdf->writeHTML($html_5, true, 0, true, 0);
        $pdf->AddPage();
...
//    $message .= '</style>';
    ...
    $message .= '<div style="width: 100%;float: left;font-size: 21px;margin-bottom:5px;">Customer Type: ' . $cus_type . '</div>';
...
//    $message .= '</div>';
    ...
    $headers  = "From: 'SohoRepro' <admin@gsparadox.com.com>\r\n" ."MIME-Version: 1.0\n" ."Content-Type: multipart/mixed;\n\tboundary=\"{$mime_boundary}\"\n\n";
