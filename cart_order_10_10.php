...
$sql = "INSERT INTO sohorepro_order_master SET order_number = '".$order_id."',order_sequence = '".$order_id."', order_id     = '" . $referece . "', customer_company = '".$company_id."', customer_name = '".$user_id."', deleivery_date = '".$deleivery_date."', order_comment = '".$comment_ord."', created_date = now()";
mysql_query($sql);
...
//$mail->Body = $message;
//$mail->Send();
$mails = array_unique($mail_id);
array_push($mails, $user_mail, $customer_email);
foreach ($mails as $to){
