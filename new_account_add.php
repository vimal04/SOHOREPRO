...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
                                                            ...
                                                            <link rel="stylesheet" type="text/css" href="store_files/style_layout.css">
                                                                ...
                                                                <script type="text/javascript">
                                                                    ...
                                                                    jQuery(function($) {
                                                                        ...
                                                                        $("#del_phone").mask("999-999-9999");
                                                                        $("#del_busizip").mask("99999");
                                                                ...
                                                                <body onload="return clear_cach_index();">
                                                                    ...
                                                                    $(document).ready(function() {
                                                                        ...
                                                                        return false;
                                                                                        ...
                                                                                        function differ_address()
                                                                                        {
                                                                                            var reg_differ = document.getElementById("reg_differ").checked;
                                                                                            if(reg_differ == true){
                                                                                                $("#differ_block").addClass('border_gle');
                                                                                                $("#diff_del_block").slideDown('slow');                                                                                                
                                                                                            }else{
                                                                                                $("#diff_del_block").slideUp('slow');
                                                                                                $("#differ_block").removeClass('border_gle');
                                                                                            }
                                                                                        }
                                                                                        </script>
                                                                                        ...
                                                                                        <?php } ?>
                                                                                            <form id="reg_form" name="reg_form" action="create_cash.php" method="post" enctype="multipart/form-data" onsubmit="return validate()" >
                                                                                            <input type="hidden" name="new_company_add" value="1" id="order_val" /> 
                                                                                            <h2 class="headline-interior orange">New Accounts </h2>
                                                                                            <div style="color: #000;">
                                                                                                Please provide the information requested below to apply for a new account. It can take up to 3 business days to process your request. Once approved, a representative will contact you to inform you of your account status. In the interim, you may use this account.
                                                                                            </div>
                                                                                            <div>&nbsp;</div>
                                                                                            <?php
                                                                                                if($_GET['for_succ'] == '1'){
                                                                                                ...
                                                                                                ?>
                                                                                            <div class="reg_head" style="clear:both;margin-bottom: 10px;">
                                                                                                Billing information : 
                                                                                            </div>   
                                                                                                ...
                                                                                                <div style="float: left;width: 40%;">
                                                                                                    <div class="label_regview">First Name<span style="color: red;">*</span> :</div> 
                                                                                                    <input intvalue="First Name" class="required reginput comp_det_view" name="reg_firstname" id="reg_firstname" type="text" placeholder="First Name" tabindex="1" />
                                                                                                    
                                                                                                    <div class="label_regview">Contact Email<span style="color: red;">*</span> :</div> 
                                                                                                    <input intvalue="Contact Email" class="required reginput comp_det_view" name="reg_contactmail" id="reg_contactmail" type="text" placeholder="Contact Email" tabindex="3" />
                                                                                                                                                                                                        
                                                                                                    <div class="label_regview">Company Name<span style="color: red;"></span> :</div> 
                                                                                                    <input intvalue="Company name" class="reginput comp_det_view" name="reg_contactname" id="reg_contactname" type="text" placeholder="Company Name" tabindex="5" />
    ...
    <!--                                                                                                <textarea class="reginput comp_det_view" name="address1" id="address1" placeholder="Address1"></textarea>-->
                                                                                                    <input type="text" class="required reginput comp_det_view" name="address1" id="address1" placeholder="Address1" tabindex="8" />
                                                                                                    
                                                                                                    <div class="label_regview"> Room/Flr/Suite :</div> 
                                                                                                    <input intvalue="Room" class="reginput comp_det_view" name="reg_busiroom" id="reg_busiroom" type="text" placeholder="Room/Flr/Suite" tabindex="10" />                                                                                                    
                                                                                                    
                                                                                                </div>
                                                                                                    
                                                                                                <div style="float: left;width: 40%;height: 180px;">
                                                                                                    
                                                                                                    <div class="label_regview">Last Name<span style="color: red;">*</span> :</div> 
                                                                                                    <input intvalue="Last name" class="required reginput comp_det_view" name="reg_lastname" id="reg_lastname" type="text" placeholder="Last Name" tabindex="2" />
                                                                                                                                                                                                        
                                                                                                    <div class="label_regview">Password<span style="color: red;">*</span> :</div> 
                                                                                                    <input intvalue="Password" class="required reginput comp_det_view" name="reg_password" id="reg_password" type="text" placeholder="Password" tabindex="4" />
                                                                                                    
                                                                                                    <div style="float:left;width: 95%;">
                                                                                                    <div class="label_regview"> Main Phone<span style="color: red;">*</span> :</div> 
                                                                                                    <input intvalue="Contact phone" class="required reginput comp_det_view" name="reg_contphone1" id="reg_contphone1" type="text" placeholder="Main Phone" tabindex="6"/>
                                                                                                    </div>
                                                                                                    ...
                                                                                                    <input type="text" class="reginput comp_det_view" name="address2" id="address2" placeholder="Address2" tabindex="9" />                                                                                              
                                                                                                </div>
                                                                                                    
                                                                                                <div style="float: left;width: 10%;margin-top: 55px;">
                                                                                                    <div class="label_regview" style="width: 60px;"> Fax :</div> 
                                                                                                    <input intvalue="fax" style="width:100px;" class="reginput comp_det_view" name="reg_busifax" id="reg_busifax" type="text" placeholder="Fax" tabindex="7" />
                                                                                                </div>
                                                                                                <div style="width:100%;float:left;">
                                                                                                    <div style="width:33%;float:left;">
                                                                                                        <div class="label_regview"> City<span style="color: red;">*</span> :</div> 
                                                                                                        <input intvalue="City" style="width: 100px;" class="required reginput comp_det_view" name="reg_busicity" id="reg_busicity" type="text" placeholder="City" tabindex="11" />
                                                                                                    </div>
                                                                                                    <div style="width:33%;float:left;">
                                                                                                    <div class="label_regview" style="width: 60px;"> State<span style="color: red;">*</span> :</div>
                                                                                                        <select name="state" id="state" class="required reginput comp_det_view" style="width: 50px;" tabindex="12" >
                                                                                                            <option value="">----</option>
                                                                                                            <?php
                                                                                                    ...
                                                                                                    <div style="width:33%;float:left;">
                                                                                                        <div class="label_regview" style="width: 60px;"> Zip<span style="color: red;">*</span> :</div> 
                                                                                                        <input intvalue="Zip" style="width: 100px;" class="required reginput comp_det_view" name="reg_busizip" id="reg_busizip" type="text" placeholder="Zip" tabindex="13" />
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div style="width:100%;float:left;">
                                                                                                    <div style="width:40%;float:left;">
                                                                                                        <div class="label_regview" style="clear:both;"> Phone 2 :</div> 
                                                                                                        <input intvalue="Phone 1" class="reginput comp_det_view" name="reg_phone1" id="reg_phone1" type="text" placeholder="Phone 2" tabindex="14" />
                                                                                                    </div>
                                                                                                    <div style="width:40%;float:left;">
                                                                                                        <div class="label_regview"> Phone 3 :</div> 
                                                                                                        <input intvalue="Phone 2" class="reginput comp_det_view"  name="reg_phone2" id="reg_phone2" type="text" placeholder="Phone 3" tabindex="15" />
                                                                                                    </div>                                                                                                    
                                                                                                </div> 
                                                                                                 ...
                                                                                                 <div style="width:100%;float:left;">
                                                                                                    <div style="width:40%;float:left;">
                                                                                                        ...
                                                                                                        <input intvalue="Phone 3" class="reginput comp_det_view"  name="reg_phone3" id="reg_phone3" type="text" placeholder="Phone 4" tabindex="16" />    
                                                                                                    </div>
                                                                                                    <div style="width:40%;float:left;">
                                                                                                        
                                                                                                        <div class="label_regview"> Tax Exemption :</div> 
                                                                                                        <input intvalue="Tax" class="reginput comp_det_view tax_exc"  name="reg_tax" id="reg_tax" type="checkbox" placeholder="Tax" value="1" tabindex="17" />
                                                                                                ...
                                                                                                <div style="width:100%;float:left;">
                                                                                                    <div id="tax_form_1" style="display: none;margin-bottom: 10px;">
                                                                                                ...
                                                                                                ?>
                                                                                                 ...
                                                                                                 <input class="reginput comp_det_view" name="reg_captcha" id="reg_captcha" type="text" style="width: 30px;" value="" tabindex="18" />
                                                                                                ...
                                                                                                <div id="differ_block" class="" style="width:100%;float:left;margin-top: 10px;">
                                                                                                    <div class="label_regview" style="width: 170px;"> Is delivery address different: </div> 
                                                                                                    <input intvalue="differ" class="reginput" style="width: 20px;"  name="reg_differ" id="reg_differ" type="checkbox" placeholder="Differ" value="1" tabindex="17" onclick="return differ_address();" />
                                                                                                </div>
                                                                                                    
                                                                                                <div id="diff_del_block" style="width:100%;float:left;display:none;margin-top: 7px;">
                                                                                                    <div style="width:40%;float:left;">
                                                                                                        <div class="label_regview"> Address1<span style="color: red;">*</span> :</div> 
    <!--                                                                                                <textarea class="reginput comp_det_view" name="address1" id="address1" placeholder="Address1"></textarea>-->
    ...
    <!--                                                                                                <textarea class="reginput comp_det_view" name="address1" id="address1" placeholder="Address1"></textarea>-->
                                                                                                        ...
                                                                                                        <div class="label_regview">Phone<span style="color: red;">*</span> :</div>     
                                                                                                        <input type="text" class="reginput comp_det_view" name="del_phone" id="del_phone" placeholder="Phone" tabindex="" />
                                                                                                    </div>
                                                                                                    
                                                                                                    <div style="width:100%;float:left;">
                                                                                                        <div style="width:33%;float:left;">
                                                                                                            <div class="label_regview"> City<span style="color: red;">*</span> :</div> 
                                                                                                            <input intvalue="City" style="width: 100px;" class="reginput comp_det_view" name="del_busicity" id="del_busicity" type="text" placeholder="City" tabindex="11" />
                                                                                                        </div>
                                                                                                        <div style="width:33%;float:left;">
                                                                                                        <div class="label_regview" style="width: 60px;"> State<span style="color: red;">*</span> :</div>
                                                                                                            <select name="del_state" id="del_state" class="reginput comp_det_view" style="width: 50px;" tabindex="12" >
                                                                                                                <option value="">----</option>
                                                                                                                <?php
                                                                                                                $sel_state = mysql_query("select * from sohorepro_states");
                                                                                                                while ($fth_states = mysql_fetch_array($sel_state)) {
                                                                                                                    ?>
                                                                                                                <option value="<?php echo $fth_states['state_id']; ?>" <?php if($fth_states['state_abbr'] == "NY"){ ?>selected="selected"<?php } ?>><?php echo $fth_states['state_abbr']; ?></option>
                                                                                                                <?php } ?>
                                                                                                            </select>
                                                                                                        </div>
                                                                                                        <div style="width:33%;float:left;">
                                                                                                            <div class="label_regview" style="width: 60px;"> Zip<span style="color: red;">*</span> :</div> 
                                                                                                            <input intvalue="Zip" style="width: 100px;" class="reginput comp_det_view" name="del_busizip" id="del_busizip" type="text" placeholder="Zip" tabindex="13" />
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
...
//                                                                                                return true;
                                                                                                 ...
                                                                                                 var reg_differ_pre = document.getElementById("reg_differ").checked;
                                                                                                 var del_address1   = $("#del_address1").val();
                                                                                                 var del_address2   = $("#del_address2").val();
                                                                                                 //var del_address3   = $("#del_address3").val();
                                                                                                 var del_phone      = $("#del_phone").val();
                                                                                                 var del_busicity   = $("#del_busicity").val();
                                                                                                 var del_state      = $("#del_state").val();
                                                                                                 var del_busizip    = $("#del_busizip").val();
...
//                                                                                                        $("#del_address2").css("border","1px solid red");
                                                                                                        ...
                                                                                                        $("#del_phone").css("border","1px solid #e4e4e4");
                                                                                                        $("#del_busicity").css("border","1px solid #e4e4e4");
                                                                                                        $("#del_busizip").css("border","1px solid #e4e4e4");
                                                                                                     }                                                                                                        
...
//                                                                                                     }  
                                                                                                     ...
                                                                                                     if(del_state == ''){
                                                                                                        $("#del_state").css("border","1px solid red");
                                                                                                        $("#del_state").focus();
                                                                                                        return false;
                                                                                                     }else{
                                                                                                        $("#del_state").css("border","1px solid #e4e4e4"); 
                                                                                                     } 
