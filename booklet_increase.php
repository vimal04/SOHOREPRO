    ...
    for ($x = 1; $x <= $booklet_value; $x++) {
        ...
        <div style="width:100%;float:left;margin-top: 10px;margin-bottom: 10px;background-color: #F6F2F2;padding: 5px;">
            ...
            <div style="width:20%;float:left;margin-bottom: 5px;">
                <label>Size</label>
                <select class="" style="" id="size_dyn_<?php echo $x_initial_value; ?>" name="size_dyn_<?php echo $x_initial_value; ?>" onchange="return change_size_dyn('<?php echo $x_initial_value; ?>');">
<!--                    <option value="N">None</option>-->
                    <option selected="selected" value="8.5x11">8.5x11</option>
            ...
            <div style="width: 79%;float: left;">
                <div style="width:20%;float:left;">
                    <div>
                        ...
                        <select class="order_0_set1_0_binding kdSelect " style="width:150px;" id="binding_main_option_<?php echo $x_initial_value; ?>" name="binding_main_option_<?php echo $x_initial_value; ?>" onchange="return get_child_option('<?php echo $x_initial_value; ?>');">
                          <!--<option value="N">None</option>-->
                ...
                <div style="width: 20%;float: left;margin-left: 40px;">
                    <div>
                        ...
                        <select class="order_0_set1_0_bindingVariation kdSelect " style="width:120px;" id="binding_child_option_<?php echo $x_initial_value; ?>" name="binding_child_option_<?php echo $x_initial_value; ?>">
                ...
                <div style="width: 20%;float: left;margin-left: 40px;">
                    <div>
                       <label>Cutting</label>
                        <select class="order_0_set1_0_bindingVariation kdSelect " style="width:120px;" id="cutting_option_dyn_<?php echo $x_initial_value; ?>" name="cutting_option_dyn_<?php echo $x_initial_value; ?>" onchange="return cutting_spl_inc_dyn('<?php echo $x_initial_value; ?>');" >
            ...
            <div style="width: 79%;float: left;margin-top: 10px;">
                 <div style="width: 20%;float: left;">                     
                        ...
                        <select class="" id="front_main_option_<?php echo $x_initial_value; ?>" name="front_main_option_<?php echo $x_initial_value; ?>" onchange="return get_child_option_front('<?php echo $x_initial_value; ?>');">
                            <option value="N">None</option>
                ...
                <div style="width: 20%;float: left;margin-left: 40px;">
                    ...
                    <select class="" id="binding_child_option_front_<?php echo $x_initial_value; ?>" name="binding_child_option_front_<?php echo $x_initial_value; ?>">
                        <option value="0">None</option>
                ...
                <div style="width: 20%;float: left;margin-left: 40px;">
                    <div>
                        ...
                        <select id="back_main_option_<?php echo $x_initial_value; ?>" name="back_main_option_<?php echo $x_initial_value; ?>"  onchange="return get_child_option_back('<?php echo $x_initial_value; ?>');" >
                            <option value="N">None</option>
                ...
                <div style="width: 20%;float: left;margin-left: 40px;">
                    <div>
                        ...
                        <select id="binding_child_option_back_<?php echo $x_initial_value; ?>" name="binding_child_option_back_<?php echo $x_initial_value; ?>">
                            <option value="0">None</option>
                            <option value="N/A">N/A</option>
                        </select>  
                    </div>
        ...
        <div id="cutting_spl_instructions_dynamic_<?php echo $x_initial_value; ?>" class="cutting_spl_instructions_dynamic" style="width: 100%;float:left;border: 1px solid #FF7E00;margin-top: 10px;display: none;">
            ...
            <br>
            <textarea placeholder="Cutting Instructions" name="special_instruction_cutting" class="splins" id="special_instruction_cutting" rows="4" cols="60" style="margin-top:-5px;margin-bottom:10px;"></textarea>
          </div>
        </div>
        <?php
    }
