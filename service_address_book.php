...
<table width="740" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
      ...
      <td align="right" valign="middle" height="55" ><a href="service_add_address.php"><img class="address" src="images/add_address.jpg"  alt="Add Shipping Address" title="Add Shipping Address" /></a></td>
  ...
  <tr bgcolor="<?php echo $rowColor; ?>">    
    ...
    <td width="97" align="center" valign="middle" class="brdr_1"><a href="edit_address_service.php?id=<?php echo $id; ?>"><img src="admin/images/edit.png"  alt="Edit Shipping Address" title="Edit Shipping Address" width="22" height="22"/></a>&nbsp;&nbsp;<a href="service_address_book.php?delete_id=<?php echo $id; ?>" onclick="return confirm('Are you sure?');"><img src="admin/images/del.png"  alt="Delete Shipping Address" title="Delete Shipping Address" width="22" height="22" class="mar_lft"/></a></td>
