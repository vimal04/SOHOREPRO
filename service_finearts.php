...
.serviceOrderSetDIV div {
    ...
    <body>
        ...
        <div style="width: 96%;padding: 2%;float: left;font-size: 14px;line-height: 37px;text-align: center;">
            ...
            <div style="width: 100%;float: left;font-weight: bold;font-size: 22px;line-height: 50px;">
                ...
                <select id="all_services">
                    ...
                    <option value="ML" selected="selected">MOUNTING & LAMINATING</option>
...
<!--                    <input type="checkbox"  style="display: none;width: 2%;" name="use_same_check" id="use_same_check_box" value="1"  onclick="return use_same_set('1');" />-->
              ...
              <div style="float:left;width:100%;text-align:right;margin-top: 10px;">                  
                  <input class="addproductActionLink" value="Save to Cart" style="cursor: pointer; float: right; font-size: 12px; padding: 1.5px; width: 135px; margin-right: 14px; -moz-border-radius: 5px; -webkit-border-radius: 5px;border:1px solid #8f8f8f;margin-top: -1px !important;" type="button" onclick="return validate_plotting_cont();" />
