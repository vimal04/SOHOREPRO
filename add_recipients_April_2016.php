            ...
            <div id="plotting" action="" method="post" class="systemForm orderform">
                  ...
                  <input type="hidden" name="user_session" id="user_session" value="<?php echo $_SESSION['sohorepro_userid']; ?>" />
                        ...
                        <div style="float:left;width: 100%;text-align: center;">
                            <div class="service_tab_gab_start">&nbsp;</div>
                            <?php
                            $services_items = ServicesItemsReci(); 
                            foreach ($services_items as $items){
                            ?>
                            <div data-toggle="tooltip" title="<?php echo $items['services_name'] ?>" class="service_tab <?php if($items['int'] == 'PAC'){?> service_active <?php } ?>" <?php if(($items['int'] != 'PAC') && ($items['int'] != 'BIN') ){?>style="display:none;"<?php } ?> ><?php echo $items['int']; ?></div>
                            <div class="service_tab_gab_end" >&nbsp;</div>
                            <?php } ?>
                            <div class="service_tab_gab_end" <?php if(($items['int'] != 'PAC') && ($items['int'] != 'BIN') ){?>style="width:55% !important;"<?php } ?>>&nbsp;</div>
                        </div>       
                <ul>                  
                    <div  id="set_1">
