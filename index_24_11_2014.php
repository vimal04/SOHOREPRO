...
<div>
 <div style="float:right;margin-top:-63px;position: relative;">
 ...
 <input aria-haspopup="true" aria-autocomplete="list" role="textbox" autocomplete="off" class="ui-autocomplete-input dec" style="padding:3px;width: 195px;" name="jobref" id="jobref" type="text" value="<?php if($_GET['refere'] != ''){echo $_GET['refere'];}else{echo ($_REQUEST['jobref'] != '') ? $_REQUEST['jobref'] : $_SESSION['ref_val'];} ?>" onblur="return dummy_reference_1();" />
 <div id="result_ref">
</div>
 </div> 
