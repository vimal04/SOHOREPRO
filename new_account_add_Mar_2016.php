...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
                                                                    ...
                                                                    $(document).ready(function() {
                                                                        ...
                                                                        return false;
                                                                                        ...
                                                                                        <?php } ?>
                                                                                            ...
                                                                                            <div style="color: #000;">
                                                                                                Please provide the information requested below to apply for a new account. It can take up to 3 business days to process your request. Once approved, a representative will contact you to inform you of your account status.
                                                                                            </div>
                                                                                            <div>&nbsp;</div>
                                                                                            <?php
                                                                                                if($_GET['for_succ'] == '1'){
                                                                                            ...
                                                                                            <div class="reg_head" style="clear:both;">
                                                                                                ...
                                                                                                <div style="float: left;width: 45%;">
                                                                                                    ...
                                                                                                    <input intvalue="First Name" class="required reginput comp_det_view" name="reg_firstname" id="reg_firstname" type="text" placeholder="First Name" />

                                                                                                    <div class="label_regview">Last Name<span style="color: red;">*</span> :</div> 
                                                                                                    <input intvalue="Last name" class="required reginput comp_det_view" name="reg_lastname" id="reg_lastname" type="text" placeholder="Last Name" />
                                                                                                    
                                                                                                    <div class="label_regview">Company Name<span style="color: red;"></span> :</div> 
                                                                                                    <input intvalue="Company name" class="reginput comp_det_view" name="reg_contactname" id="reg_contactname" type="text" placeholder="Company Name" />
                                                                                                </div>
                                                                                                    
                                                                                                <div style="float: left;width: 45%;height: 110px;">
                                                                                                    ...
                                                                                                    <input intvalue="Password" class="required reginput comp_det_view" name="reg_password" id="reg_password" type="text" placeholder="Password"/>
                                                                                                </div>
                                                                                                    

                                                                                                <div style="float: left;width: 45%;">
                                                                                                    <div class="label_regview"> Main Phone<span style="color: red;">*</span> :</div> 
                                                                                                    <input intvalue="Contact phone" class="required reginput comp_det_view" name="reg_contphone1" id="reg_contphone1" type="text" placeholder="Main Phone"/>
    ...
    <!--                                                                                                <textarea class="reginput comp_det_view" name="address1" id="address1" placeholder="Address1"></textarea>-->
                                                                                                ...
                                                                                                <div style="float: left;width: 45%;height: 180px;">
