...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function delete_order_item(ID, ORDER_ID)
            {
                var total_item = $("#total_item_"+ORDER_ID).val();
                if(total_item > "1"){  
                    $.ajax
                    ({
                    type: "POST",
                    url: "get_child.php",
                    data: "delete_order_item=1&item_id="+ID+"&order_id="+ORDER_ID,
                    beforeSend: loadStart,
                    complete: loadStop,
                    success: function(option)
                    {
                        if(option == true){
                        setTimeout("location.href=\'open_orders.php?ord_id="+ID+"&ord_id="+ORDER_ID+"\'", 1000);
                        }
                    }
                    });

                }else{
                    alert("This Order has only one Item. You can't delete this.");
                    return false;
                }
            }
                                                        ...
                                                        <tr><td align="left" valign="top" style="padding-top:10px">
                                                                <div id="inline_edit">                                        
                                                                    <table width="735" align="center" cellspacing="0" cellpadding="0" border="0">
                                                                        ...
                                                                        ?>
                                                                        <tr style="color:#fff;">                               
                                                                            <td width="285" align="left" valign="middle" bgcolor="#f68210" class="brdr pad_lft">Product Details</td>
                                                                            ...
                                                                            <input type="hidden" name="total_item_<?php echo $id; ?>" id="total_item_<?php echo $id; ?>" value="<?php echo count($view_orders); ?>" />
                                                                        </tr>
                                                                        <?php
