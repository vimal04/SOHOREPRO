...
function getOrdersAll($sorting,$start,$limit) {
    //return $sorting;
    if($sorting == 'a'){
    $select_orders = "SELECT * FROM sohorepro_order_master WHERE closed_status = '0'  ORDER BY created_date ASC LIMIT $start, $limit";  
    }  
    elseif($sorting == 'd') 
    {
    $select_orders = "SELECT * FROM sohorepro_order_master WHERE closed_status = '0' ORDER BY created_date DESC LIMIT $start, $limit";     
    }
    elseif($sorting == 'jnd') 
    {
    $select_orders = "SELECT * FROM sohorepro_order_master WHERE closed_status = '0' ORDER BY order_id DESC LIMIT $start, $limit";     
    }
    elseif($sorting == 'jna') 
    {
    $select_orders = "SELECT * FROM sohorepro_order_master WHERE closed_status = '0' ORDER BY order_id ASC LIMIT $start, $limit";     
    }
    
    elseif($sorting == 'pd') 
    {
    $select_orders = "SELECT * FROM sohorepro_order_master WHERE closed_status = '0' ORDER BY customer_company_name DESC LIMIT $start, $limit";     
    }
    elseif($sorting == 'pa') 
    {
    $select_orders = "SELECT * FROM sohorepro_order_master WHERE closed_status = '0' ORDER BY customer_company_name ASC LIMIT $start, $limit";     
    }
    
    else 
    {
    $select_orders = "SELECT * FROM sohorepro_order_master WHERE closed_status = '0' ORDER BY id DESC LIMIT $start, $limit";        
    }
...
function ShowOrderedSets($ordere_sequence) {
   $select_fav = "SELECT * FROM sohorepro_order_master_service WHERE order_sequence = '".$ordere_sequence."'" ;
    $details       = mysql_query($select_fav);
    while ($object = mysql_fetch_assoc($details)):
        $value[] = $object;
    endwhile;
