...
$message .= '<div style="width: 100%;float: left;font-size: 21px;">ORDER COMPLETE : ORDER # '.$_SESSION['order_number'].'</div>';
$message .= '<div style="width: 100%;float: left;">JOB REFERENCE  : '.$Order_id.'</div>';
$message .= '</td></tr>';
