...
<!--                                                                            <tr>                                                                                        
            ...
            <?php $customer_per_company = custPerComp($cumpony_id); ?>
                                                                            ...
                                                                            <!-- Tax Cerificate Show Start --->
                                                                            <tr>
                                                                                <td colspan="3">
                                                                                    <table>
                                                                                        <?php if($Prod['tax_form_resale'] != ''){ ?>
                                                                                        <tr>
                                                                                            <td>
                                                                                                <span style="font-weight: bold;">Resale Certificate:</span>&nbsp;<a href="../tax_form/<?php echo $Prod['tax_form_resale']; ?>" target="_blank"><?php echo $Prod['tax_form_resale']; ?></a>
                                                                                            </td>                                                                                
                                                                                        </tr>
                                                                                        <?php }if($Prod['tax_form_excempt'] != ''){ ?>
                                                                                        <tr>
                                                                                            <td>
                                                                                                <span style="font-weight: bold;">Exempt Use Certificate:</span>&nbsp;<a href="../tax_form/<?php echo $Prod['tax_form_excempt']; ?>" target="_blank"><?php echo $Prod['tax_form_excempt']; ?></a>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <?php } ?>
                                                                                    </table>
...
<?php if ($_SESSION['admin_user_type'] == '1') { ?>
            ...
            //Devivary Address Inline Edit Start
            ...
            //Devivary Address Inline Edit End
             ...
             $('.ad1_del_update').click(function()
            {
                ...
                $.ajax
                        ({
                            type: "POST",
                            url: "customers_edit_inline.php",
                            data: "id=" + ID + "&del_address_1=" + ad1_val,
                            success: function(option)
                            {
                ...
                if (ad2_val != '') {
                    ...
                    $.ajax
                            ({
                                type: "POST",
                                url: "customers_edit_inline.php",
                                data: "id=" + ID + "&del_address_2=" + ad2_val,
                                success: function(option)
                                {
                ...
                if (ad2_val != '') {
                    ...
                    $.ajax
                            ({
                                type: "POST",
                                url: "customers_edit_inline.php",
                                data: "id=" + ID + "&del_address_3=" + ad2_val,
                                success: function(option)
                                {
                                    $(".bus_add3_inline_span_" + ID).html(option);
                                    $(".bus_add3_inline_span_" + ID).css("display", "inline-block");
