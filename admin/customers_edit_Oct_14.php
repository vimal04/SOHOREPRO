        ...
        <table border="0" width="100%" class="cust_edit_tab">
            <?php if (mysql_num_rows($res) > 0) { ?>
                ...
                <tr>
                    ...
                    <td align="left">
                        <span class="edit_password cus_password_<?php echo $company_id; ?>_<?php echo $customer_id; ?>" id="cus_password_<?php echo $company_id; ?>_<?php echo $customer_id; ?>" style="cursor: pointer;"><?php echo $object['cus_pass']; ?></span>
