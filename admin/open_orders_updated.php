      ...
      <tr>
        ...
        <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
          <tbody>
            ...
            <tr>
                <?php
                $AddressDetaisl = ShippingAddressAllForGuest($object['customer_company']);                
                ...
                ?>               
                <td class="pointer"><a style="text-decoration: none;color: #000;" class="fancybox fancybox.iframe"  href="edit_guest_add.php?comp_id=<?php echo $object['customer_company']; ?>&acc_id=<?php echo $id; ?>" ><?php echo $add1.$add2.$add3.$city.'</br>'.StateName($state).'</br>'.$zip; ?></a></td>
            </tr>           
          </tbody>
        </table></td>
      </tr>
    ...
    <td align="left" valign="top"><table cellpadding="0" border="0" align="left" cellspacing="0">
      <tbody>
        ...
        ?>        
          ...
          <tr align="right">
            <td valign="bottom"><?php echo Paginations($limit,$page,'open_orders.php?page=',$rows);?></td>
          </tr>
        </table></td>
      </tr>
