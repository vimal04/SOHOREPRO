...
function AdminAlertActive($reg_compname, $reg_contactname, $activate_comp) {
    $message_admin = '<html>';
    $message_admin .='<head>';
    $message_admin .='<title></title>';
    $message_admin .='<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">';
    $message_admin .='</head>';
    $message_admin .='<body>';
    $message_admin .='<table width="550" border="0" cellspacing="0" cellpadding="0">';
    $message_admin .='<tr bgcolor="#ff7e00">';
    $message_admin .='<td width="10" height="10" align="left" valign="top"></td>';
    $message_admin .='<td height="10" align="left" valign="top"></td>';
    $message_admin .='<td width="10" height="10" align="left" valign="top"></td>';
    $message_admin .='</tr>';
    $message_admin .='<tr>';
    $message_admin .='<td width="10" align="left" valign="top" bgcolor="#ff7e00"></td>';
    $message_admin .='<td align="left" valign="top">';
    $message_admin .='<table width="530" border="0" cellspacing="0" cellpadding="0">';
    $message_admin .='<tr>';
    $message_admin .='<td width="20" height="20" align="left" valign="top"></td>';
    $message_admin .='<td height="20" align="left" valign="top"></td>';
    $message_admin .='<td width="20" height="20" align="left" valign="top"></td>';
    $message_admin .='</tr>';
    $message_admin .='<tr>';
    $message_admin .='<td width="20" align="left" valign="top"></td>';
    $message_admin .='<td align="left" valign="top">';
    $message_admin .='<table width="490" border="0" cellspacing="0" cellpadding="0">';
    $message_admin .='<tr>';
    $message_admin .='<td width="100" align="left" valign="top"><img src="http://supply.sohorepro.com/store_files/soho_logo.jpg" width="126" height="115" alt=""/></td>';
    $message_admin .='<td width="40" align="left" valign="top"></td>';
    $message_admin .='<td width="350" align="left" valign="top">';
    $message_admin .='<table width="350" border="0" cellspacing="0" cellpadding="0" style="margin-right:-1px;">';
    $message_admin .='<tr>';
    $message_admin .='<td height="25" align="left" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:15px; color:#ff7e00; font-weight:bold;">Dear Admin,</br></td>';
    $message_admin .='</tr>';
    $message_admin .='<tr>';
    $message_admin .='<td align="left" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#444444">';
    $message_admin .='<table>';
    $message_admin .='<tr>';
    $message_admin .='<td>New user has been registered</td>';
    $message_admin .='</tr>';
    if($reg_compname != ''){
    $message_admin .='<tr>';
    $message_admin .='<td>Company Name : ' . $reg_compname . '</td>';
    $message_admin .='</tr>';
    }
    $message_admin .='<tr>';
    $message_admin .='<td>Contact Name : ' . $reg_contactname . '</td>';
    $message_admin .='</tr>';
    $message_admin .='<tr>';
    $message_admin .='<td><a href="http://cipldev.com/supply-new.sohorepro.com/admin/customers.php?cus_add_id='.$activate_comp.'" target="_blank">http://cipldev.com/supply-new.sohorepro.com/admin/customers.php</a></td>';
    $message_admin .='</tr>';
    $message_admin .='</table>';
    $message_admin .='</td>';
    $message_admin .='</tr>';
    ...
    $message_admin .='</body>';
    $message_admin .='</html>';
    //$final_html = html_entity_decode($message_admin);

    $mail_id_admin = getActiveEmail();

    foreach ($mail_id_admin as $to) {
        $subject_admin = 'New Account Created by ' . $reg_compname;
        $headers_admin = 'From: "SohoRepro" <noreply@sohorepro.com>' . "\r\n";
        $headers_admin .= "MIME-Version: 1.0" . "\r\n";
        $headers_admin .= "Content-type:text/html;charset=iso-8859-1" . "\r\n";
        $to = $to['email_id'];
        $result_mail = mail($to, $subject_admin, $message_admin, $headers_admin);
    }
    if ($result_mail) {
        return '1';
    } else {
