                ...
                <td align="center" valign="top">
                    <table width="960" border="0" cellspacing="0" cellpadding="0" style="min-width:760px;">
                                                                            ...
                                                                            <tr>                                                                           
                                                                                ...
                                                                                <td align="left" width="250">
                                                                                    <table border="0" width="325">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="left">
                                                                                                <strong style="float:left;">A3 :&nbsp;</strong><span style="cursor: pointer;" class="bus_add3_inline bus_add3_inline_span_<?php echo $cumpony_id; ?>" id="<?php echo $cumpony_id; ?>"><?php echo $user_address3_ori; ?></span>
                                                                                                <span style="float:left;" class="none bus_add3_lbl_<?php echo $cumpony_id; ?>"><input style="float:left; width: 150px;" type="text" class="none bus_add3_inline_txt_<?php echo $cumpony_id; ?>" id="bus_add3_inline_txt_<?php echo $cumpony_id; ?>" value="<?php echo $user_address3_ori; ?>" />
                                                                                ...
                                                                                <td width="250">
                                                                                    <table border="0" width="300">
                                                                                        <tr>                                                                                        
                                                                                            <td width="200">
                                                                                                <?php $del_comp = ($deleivery_address[0]['company_name'] == '') ? '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' : $deleivery_address[0]['company_name']; ?>
                                                                                                <span class="cus_id" id="<?php echo $cumpony_id; ?>"></span>
                                                                                                <span style="float:left;"><strong>C :&nbsp;</strong></span><span style="cursor: pointer;" class="del_inline del_inline_span_<?php echo $cumpony_id; ?>" id="<?php echo $cumpony_id; ?>"><?php echo $del_comp; ?></span>                                                                                                                                                                        
                                                                                                <input style="float:left;width:140px;" type="text" class="none del_inline_txt_<?php echo $cumpony_id; ?>" id="del_inline_txt_<?php echo $cumpony_id; ?>" value="<?php echo $del_comp; ?>" />
                                                                                        ...
                                                                                        <?php
                                                                                        $del_add_3 = ($deleivery_address[0]['address_3'] == '') ? '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' : $deleivery_address[0]['address_3'];
                                                                                        ?>
                                                                                        <tr>                                                                                       
                                                                                            <td>
                                                                                                <span style="float:left;"><strong>A3 :&nbsp;</strong></span><span style="cursor: pointer;" class="del_add3_inline del_add3_inline_span_<?php echo $cumpony_id; ?>" id="<?php echo $cumpony_id; ?>"><?php echo $del_add_3; ?></span>                                                                                                                                                                        
                                                                                                <input style="float:left;width: 140px;" type="text" class="none del_add3_inline_txt_<?php echo $cumpony_id; ?>" id="del_add3_inline_txt_<?php echo $cumpony_id; ?>" value="<?php echo $del_add_3; ?>" />
                                                                                                        ...
                                                                                                        <td align="left">
                                                                                                            <table border="0">
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <span style="cursor: pointer;margin-left: -17px;" class="del_stat_inline del_stat_inline_span_<?php echo $cumpony_id; ?>" id="<?php echo $cumpony_id; ?>"><?php echo StateName($deleivery_address[0]['state']); ?></span>&nbsp;
                        ...
                        <!--                                                                            <tr>                                                                                        
                                                                            ...
                                                                            <tr>
                                                                                <td width="30%" class="inf" style="padding-left: 3px;">
                                                                                    <span style="font-weight: bold;">Cust. ID : </span> <?php echo getCompName($cumpony_id); ?>
                                                                                </td>
...
<tr>
    <td style="background:#464646; text-align:center; color:#fff; line-height:30px;" height="30p">© <?php echo date("Y"); ?> sohorepro.com</td>
             ...
             <?php if($_GET['cus_id'] != ''){ ?>   
        <script>
            //document.getElementById('new_supercategory').submit();
        </script>
        <?php } ?> 
...
//     }
    ...
    function autosuggession()
    {
        ...
        var dataString = 'search=' + searc_name;
        if (searc_name != '')
        {
            $.ajax({
                type: "POST",
