                                                                        ...
                                                                        <table width="100%" border="0">
                                                                            ...
                                                                            <tr>                                                                           
                                                                                ...
                                                                                <table border="0" width="250">
                                                                                    <tr>                                                                                        
                                                                                        <td width="200">
                                                                                            <strong style="float:left;">C :&nbsp;</strong><span class="cus_id" id="<?php echo $cumpony_id; ?>"></span>
                                                                                            ...
                                                                                            <span style="float:left;" class="none bus_comp_lbl_<?php echo $cumpony_id; ?>"></span><input style="float:left;width: 150px;" type="text" class="none bus_inline_txt_<?php echo $cumpony_id; ?>" id="bus_inline_txt_<?php echo $cumpony_id; ?>" value="<?php echo $company_name; ?>" />
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="left">
                                                                                            <strong style="float:left;">A2 :&nbsp;</strong><span style="cursor: pointer;" class="bus_add2_inline bus_add2_inline_span_<?php echo $cumpony_id; ?>" id="<?php echo $cumpony_id; ?>"><?php echo $user_address2; ?></span>
                                                                                            <span style="float:left;" class="none bus_add2_lbl_<?php echo $cumpony_id; ?>"><input style="float:left; width: 150px;" type="text" class="none bus_add2_inline_txt_<?php echo $cumpony_id; ?>" id="bus_add2_inline_txt_<?php echo $cumpony_id; ?>" value="<?php echo $user_address2; ?>" />
                                                                                    ...
                                                                                    <?php if($user_address3 != ''){ ?>
                                                                                    <tr>                                                                                       
                                                                                        <td>
                                                                                            <span style="cursor: pointer;" class="bus_add3_inline bus_add3_inline_span_<?php echo $cumpony_id; ?>" id="<?php echo $cumpony_id; ?>"><strong>A3 :&nbsp;</strong><?php echo $user_address3; ?></span>
                                                                                            <span class="none bus_add3_lbl_<?php echo $cumpony_id; ?>"><strong>A3 :&nbsp;</strong></span><input style="float:left;width: 150px;" type="text" class="none bus_add3_inline_txt_<?php echo $cumpony_id; ?>" id="bus_add3_inline_txt_<?php echo $cumpony_id; ?>" value="<?php echo $user_address3; ?>" />
                                                                        ...
                                                                        <table border="0" width="240">
                                                                            <tr>                                                                                        
                                                                                <td width="200">
                                                                                    ...
                                                                                    <span style="float:left;"><strong>C :&nbsp;</strong></span><span style="cursor: pointer;" class="del_inline del_inline_span_<?php echo $cumpony_id; ?>" id="<?php echo $cumpony_id; ?>"><?php echo $deleivery_address[0]['company_name']; ?></span>                                                                                                                                                                        
                                                                                    <input style="float:left;width:140px;" type="text" class="none del_inline_txt_<?php echo $cumpony_id; ?>" id="del_inline_txt_<?php echo $cumpony_id; ?>" value="<?php echo $deleivery_address[0]['company_name']; ?>" />
                                                                            ...
                                                                            <tr>                                                                                       
                                                                                <td>
                                                                                    <span style="float:left;"><strong>A1 :&nbsp;</strong></span><span style="cursor: pointer;" class="del_add1_inline del_add1_inline_span_<?php echo $cumpony_id; ?>" id="<?php echo $cumpony_id; ?>"><?php echo $deleivery_address[0]['address_1']; ?></span>                                                                                                                                                                        
                                                                                    <input style="float:left;width:140px;" type="text" class="none del_add1_inline_txt_<?php echo $cumpony_id; ?>" id="del_add1_inline_txt_<?php echo $cumpony_id; ?>" value="<?php echo $deleivery_address[0]['address_1']; ?>" />
                                                                            ...
                                                                            <tr>
                                                                                <td align="left">
                                                                                    <span style="float:left;"><strong>A2 :&nbsp;</strong></span><span style="cursor: pointer;" class="del_add2_inline del_add2_inline_span_<?php echo $cumpony_id; ?>" id="<?php echo $cumpony_id; ?>"><?php echo $deleivery_address[0]['address_2']; ?></span>   
                                                                                    <input style="float:left; width: 140px;" type="text" class="none del_add2_inline_txt_<?php echo $cumpony_id; ?>" id="del_add2_inline_txt_<?php echo $cumpony_id; ?>" value="<?php echo $deleivery_address[0]['address_2']; ?>" />
                                                                             ...
                                                                             <?php  if($deleivery_address[0]['address_3'] != ''){ ?>
                                                                            <tr>                                                                                       
                                                                                <td>
                                                                                    <span style="float:left;"><strong>A3 :&nbsp;</strong></span><span style="cursor: pointer;" class="del_add3_inline del_add3_inline_span_<?php echo $cumpony_id; ?>" id="<?php echo $cumpony_id; ?>"><?php echo $deleivery_address[0]['address_3']; ?></span>                                                                                                                                                                        
                                                                                    <input style="float:left;width: 140px;" type="text" class="none del_add3_inline_txt_<?php echo $cumpony_id; ?>" id="del_add3_inline_txt_<?php echo $cumpony_id; ?>" value="<?php echo $deleivery_address[0]['address_3']; ?>" />
...
<!--                                                                            <tr>                                                                                        
            ...
            <?php $customer_per_company = custPerComp($cumpony_id); ?>
                                                                            ...
                                                                            <tr>
                                                                                <td width="33%" class="inf" style="font-weight: bold;padding-left: 3px;">&nbsp;</td>
                                                                                <td width="33%" class="inf">
                                                                                    <table>
                                                                                        <tr>
                                                                                            <td>
...
<?php if ($_SESSION['admin_user_type'] == '1') { ?>
            ...
            $('.cn_update').click(function()
            {
                ...
                var cname_val_rep = cname_val.replace("&", "and");
                //alert(cname_val);        
                if (cname_val != '') {
            ...
            $('.ad1_update').click(function()
            {
                ...
                $.ajax
                        ({
                            type: "POST",
                            url: "customers_edit_inline.php",
                            data: "id=" + ID + "&bus_address_1=" + encodeURIComponent(ad1_val),
                            success: function(option)
                            {
             ...
             $('.ad1_del_update').click(function()
            {
                ...
                $.ajax
                        ({
                            type: "POST",
                            url: "customers_edit_inline.php",
                            data: "id=" + ID + "&del_address_1=" + encodeURIComponent(ad1_val),
                            success: function(option)
                            {
                ...
                if (ad2_val != '') {
                    ...
                    $.ajax
                            ({
                                type: "POST",
                                url: "customers_edit_inline.php",
                                data: "id=" + ID + "&bus_address_2=" + encodeURIComponent(ad2_val),
                                success: function(option)
                                {
                ...
                if (ad2_val != '') {
                    ...
                    $.ajax
                            ({
                                type: "POST",
                                url: "customers_edit_inline.php",
                                data: "id=" + ID + "&del_address_2=" + encodeURIComponent(ad2_val),
                                success: function(option)
                                {
                ...
                if (ad2_val != '') {
                    ...
                    $.ajax
                            ({
                                type: "POST",
                                url: "customers_edit_inline.php",
                                data: "id=" + ID + "&bus_address_3=" + encodeURIComponent(ad2_val),
                                success: function(option)
                                {
                ...
                if (ad2_val != '') {
                    ...
                    $.ajax
                            ({
                                type: "POST",
                                url: "customers_edit_inline.php",
                                data: "id=" + ID + "&del_address_3=" + encodeURIComponent(ad2_val),
                                success: function(option)
                                {
                                    $(".bus_add3_inline_span_" + ID).html(option);
                                    $(".bus_add3_inline_span_" + ID).css("display", "inline-block");
