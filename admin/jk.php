...
if (isset($_REQUEST['new_company_add']) == '1') {
    ...
    $sql_user_create = "INSERT INTO sohorepro_customers SET
             cus_fname = '" . mysql_real_escape_string($reg_contactname) . "', 
             cus_lname = '" . $reg_lname . "',
    ...
    $message    = 'Hi '.$reg_contactname.',<br><br>';
    $message   .= 'Thank you for providing your information. Please <a href="'.$base_url.'/supply-new.sohorepro.com/activate_msg.php?activate_comp='.$_SESSION['com_id_last'].'&activate_usr='.$usr_id.'" target="_blank">CLICK HERE</a> to activate your account<br><br><br>';
    $message   .= 'Thank you<br>';
    $message   .= '<b>Sohorero Graphics</b><br>';
