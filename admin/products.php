                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <table width="759" border="0" cellspacing="0" cellpadding="0" class="product filter_box">
                                                                ...
                                                                <tr style="background: #fcd9a9;">
                                                                    ...
                                                                    <td width="200" height="60" align="left" style="font-size:14px;" valign="middle">
                                                                        <!--<span class="specialty_button" onclick="return reset_filter();">Specialty Items</span>-->
                                                                        <a class="specialty_button" href="specialty_items.php">Specialty Items</a>
                                                                    </td>
                                                                </tr>
