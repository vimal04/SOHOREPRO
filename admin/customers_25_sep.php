                                                            ...
                                                            <table width="600" border="0" cellspacing="0" cellpadding="0" >
                                                                <tr style="float:left;">
                                                                    <td width="160" height="60" align="right" valign="middle">
                                                                        <input class="input_text" type="text" name="search_val" id="search_val" type="text" value="<?php echo $_REQUEST['search_val']; ?>" placeholder="Search Company" style="width:300px !important; margin-left: 25px;" >
                                                                    </td>
