...
$message .= '<tr><td>';
$message .= '<table align="left" border="0">';
for ($m = 0; $m<count($address_for_items_pre); $m+=3)
{
    $message.= '<tr>
                <td valign="top">'.$address_for_items_pre[$m].'</td>
                <td valign="top">'.$address_for_items_pre[$m+1].'</td>
                <td valign="top">'.$address_for_items_pre[$m+2].'</td>
            </tr>';
    $message.= '<tr><td>&nbsp;</td></tr>';
}
$message .= '</table>';
