...
<div style="float: left;width: 30%;">
    <ul class="navigation primary" style="float:left !important;width: 100%;">
            <li class="navLargeFormat" style=" border-bottom: none !important;">
                <a href="#" style="<?php if($page_name_new=='index.php') { echo "font-weight: bold;"; } ?>">SUPPLIES</a>
            </li>
            <li class="navLargeFormat" style=" border-bottom: none !important;">
                <a href="#" style="<?php if($page_name_new=='service_plotting.php') { echo "font-weight: bold;"; } ?>">SERVICES</a>
            </li>
        </ul>
</div>  
<div style="float: right;width: 70%;">        
        <ul class="navigation primary" style="float:right !important;">
            <li class="navPlotting" style=" border-bottom: none !important;">
                <a href="#" style="font-weight: bolder;color: #F00 !important;">WELCOME <?php echo strtoupper($_SESSION['sohorepro_username']); ?></a>
                <div style="float: left;width: 100%;padding: 0px;margin-top: -10px;"><?php echo $comp_name; ?></div>
            </li>
            <li class="navLargeFormat" style=" border-bottom: none !important;"><a href="#" style="<?php if($page_name_new=='service_address_book.php') { echo "font-weight: bold;"; } ?>">ADDRESS BOOK</a></li>
            <li class="navLargeFormat" style=" border-bottom: none !important;"><a href="#" style="<?php if($page_name_new=='shoppingcart.php') { echo "font-weight: bold;"; } ?>">CART</a></li>
            <!--<li class="navLargeFormat" style=" border-bottom: none !important;"><a href="#" style="color:  #007F2A !important;<?php if($page_name_new=='help_box_logged.php') { echo "font-weight: bold;"; } ?>">HELP BOX</a></li>-->            
            <li class="navLargeFormat" style=" border-bottom: none !important;"><a href="#">LOGOUT</a></li>            
        </ul>
...
<div style="float: right;">        
        <ul class="navigation primary" style="float:right !important;width: 100%;">            
            <li class="navLargeFormat" style=" border-bottom: none !important;"><a href="#" style="cursor: pointer;color:  #007F2A !important;">HELP BOX</a></li>            
        </ul>
        <div style="clear:both"></div> 
</div>   
<?php
