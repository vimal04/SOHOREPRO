...
//                $('#add_recipients').slideDown();
 ...
 function add_recipients_dynamic(OPTION_ID){
...
//                }
     ...
     if(multi == true){
		$.ajax
                ({
					...
					$('#multi_recipients').slideDown();
					$('#multi_recipients').html(element[3]);
                                        $('.all_are_done').show();    
                                        $('.all_are_done').attr('onclick', 'return add_recipients_dynamic('+element[2]+');');
					}
				}
                });
	}
 ...
 function add_prvious(OPTION_ID){
...
function ste_function(){
 ...
 function update_exist_address(ID)
 {
     ...
     $.ajax
        ({
           type: "POST",
           url: "get_recipients.php",
           data: "recipients=85&address_1="+encodeURIComponent(address_1)+"&address_2="+encodeURIComponent(address_2)+"&address_3="+encodeURIComponent(address_3)+"&address_city="+encodeURIComponent(address_city)+"&address_state_select="+address_state_select+"&address_zip="+encodeURIComponent(address_zip)+"&address_id="+ID,
           beforeSend: loadStart,
           complete: loadStop,
           success: function(option)
           {  
    ...
    $.ajax
        ({
           ...
           {  
               ...
               $("#jumbalakka_nmj").css("margin-top", "75px");
 ...
 {
     var company_name               = $("#company_name_closer").val();
     var attention_to               = $("#attention_to_closer").val();
     var address_1                  = $("#address_1_closer").val();
     var address_2                  = $("#address_2_closer").val();
     var address_3                  = $("#address_3_closer").val();
     var address_city               = $("#city_closer").val();
     var address_state_select       = $("#state_closer").val();
     var address_zip                = $("#company_zip_closer").val();
     var phone                      = $("#company_phone_closer").val();
     
     if(company_name == ''){
         $("#company_name_closer").css("border", "1px solid #EA4335");
         $("#company_name_closer").focus();
         return false;
     }else{
         $("#company_name_closer").css("border", "1px solid #ccc");        
     }
     
     if(attention_to == ''){
         $("#attention_to_closer").css("border", "1px solid #EA4335");
         $("#attention_to_closer").focus();
         return false;
     }else{
         $("#attention_to_closer").css("border", "1px solid #ccc");
     }
     
     if(address_1 == ''){
         $("#address_1_closer").css("border", "1px solid #EA4335");
         $("#address_1_closer").focus();
         return false;
     }else{
         $("#address_1_closer").css("border", "1px solid #ccc");
     }
          
     if(address_city == ''){
         $("#city_closer").css("border", "1px solid #EA4335");
         $("#city_closer").focus();
         return false;
     }else{
         $("#city_closer").css("border", "1px solid #ccc");
     }
     
     if(address_state_select == '0'){
         $("#state_closer").css("border", "1px solid #EA4335");
         $("#state_closer").focus();
         return false;
     }else{
         $("#state_closer").css("border", "1px solid #ccc");
     }
     
     if(address_zip == ''){
         $("#company_zip_closer").css("border", "1px solid #EA4335");
         $("#company_zip_closer").focus();
         return false;
     }else{
         $("#company_zip_closer").css("border", "1px solid #ccc");
     }
     
     if(phone == ''){
         $("#company_phone_closer").css("border", "1px solid #EA4335");
         $("#company_phone_closer").focus();
         return false;
     }else{
         $("#company_phone_closer").css("border", "1px solid #ccc");
     }
