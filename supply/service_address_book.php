...
if ($_GET[ 'redirect']=='serivce_recipient' ) { 
    ?>
<script>
    setTimeout("location.href=\'add_recipients.php?address_ste=1\'", 1000);
</script>
<?php } if ($_GET[ 'delete_id']) { 
    $delete_id=$_GET[ 'delete_id']; 
    $sql="DELETE FROM sohorepro_address_service WHERE id = " . $delete_id . " "; 
    $sql_result=mysql_query($sql); if ($sql_result) { $result="success" ; } else { $result="failure" ; } } ?>
...
<head>
    ...
    <style type="text/css">
        ...
        .product_table .brdr_1 {
            border-top: 1px solid #fff;
            border-right: 1px solid #ffc68f;
        }
        .product_table .brdr_2 {
            border-right: 1px solid #ffc68f;
        }
        .product_table .brdr_3 {
            border-top: 1px solid #ffc68f;
            border-right: 1px solid #ffc68f;
        }
        .product_table input[type="button"] {
            background: url(images/remove_btn1.png) no-repeat center;
            width: 72px;
            height: 23px;
            border: 0px;
            font-size: 0px;
        ...
        .product_table .pad_none {
            padding: 2px !important;
        }
        .product_table .pad_none td {
    ...
    <!--[if IE 7]> <link rel="stylesheet" type="text/css" href="css/ie_7_hacks.css" /> <![endif]-->
                ...
                <div id="content_output">
                    ...
                    <div id="content_output-data" style="margin-bottom:20px;">
                        ...
                        <div id="cart_tabl">
                            ...
                            <script>
                                setTimeout("location.href=\'addressbook.php\'", 1000);
                            </script>
                            ...
                            <table width="740" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="right" valign="middle" height="55">
                                        <a href="service_add_address.php"><img class="address" src="images/add_address.jpg" alt="Add Shipping Address" title="Add Shipping Address" />
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" valign="top">
                                        <table width="740" border="0" cellspacing="0" cellpadding="0" class="product_table">
                                            ...
                                            <?php if (count($primary_shipping)> 0) { $j = 1; foreach ($primary_shipping as $primary) { $rowColor = ($j % 2 != 0) ? '#ffeee1' : '#fff6f0'; $id = $primary['id']; $comp_id = $primary['comp_id']; $comp_name = ($primary['company_name'] != '') ? $primary['company_name'] . '</br>' : ''; $address_1 = ($primary['address_1'] != '') ? $primary['address_1'] . '</br>' : ''; $address_2 = ($primary['address_2'] != '') ? $primary['address_2'] . '</br>' : ''; $address_3 = ($primary['address_3'] != '') ? $primary['address_3'] . '</br>' : ''; $city = $primary['city']; $state = StateName($primary['state']); $zip = $primary['zip']; $zip_ext = $primary['zip_ext']; $zip_e = ($primary['zip_ext'] != '') ? '+' : ''; $attention = ($primary['attention_to'] != '') ? $primary['attention_to'] . '</br>' : ''; $phone = ($primary['phone']) ? $primary['phone'] : ''; $type = $primary['type']; ?>
                                            <tr bgcolor="<?php
        echo $rowColor;
?>">
                                                <td width="48" align="center" valign="middle" class="brdr_1">
                                                    <?php echo $j; ?>
                                                </td>
                                                <td width="243" align="left" valign="middle" class="brdr_1">
                                                    <?php echo $comp_name . $attention . $address_1 . $address_2 . $address_3 . $city . ',  ' . $state . '&nbsp;' . $zip . $zip_e . $zip_ext . '</br>' . $phone; ?>
                                                </td>
                                                <td width="97" align="center" valign="middle" class="brdr_1">
                                                    <?php if ($type=='1' ) { ?><span style="font-weight: bold !important;">Primary Shipping Address</span>
                                                    </br>
                                                    </br>
                                                    <?php } if ($user_manager=='1' ) { ?>
                                                    <a href="edit_address.php?id=<?php
            echo $id;
?>"><img src="admin/images/edit.png" alt="Edit Shipping Address" title="Edit Shipping Address" width="22" height="22" />
                                                    </a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                            <?php } } if (count($shipping_address)> 0) { $i = 2; foreach ($shipping_address as $address) { $rowColor = ($i % 2 != 0) ? '#ffeee1' : '#fff6f0'; $id = $address['id']; $comp_id = $address['comp_id']; $comp_name = ($address['company_name'] != '') ? $address['company_name'] . '</br>' : ''; $attention = ($address['attention_to'] != '') ? $address['attention_to'] . '</br>' : ''; $address_1 = ($address['address_1'] != '') ? $address['address_1'] . '</br>' : ''; $address_2 = ($address['address_2'] != '') ? $address['address_2'] . '</br>' : ''; $address_3 = ($address['address_3'] != '') ? $address['address_3'] . '</br>' : ''; $city = $address['city']; $state = StateName($address['state']); $zip = $address['zip']; $zip_ext = $address['zip_ext']; $zip_e = ($address['zip_ext'] != '') ? '+' : ''; $phone = ($address['phone'] != '') ? $address['phone'] : ''; $ext = ($address['extension'] != '') ? $address['extension'] : ''; $type = $address['type']; ?>
                                            <tr bgcolor="<?php
        echo $rowColor;
?>">
                                                <td width="48" align="center" valign="middle" class="brdr_1">
                                                ...
                                                <td width="243" align="left" valign="middle" class="brdr_1">
                                                    <?php echo $comp_name . $attention . $address_1 . $address_2 . $address_3 . $city . ',  ' . $state . '&nbsp;' . $zip . $zip_e . $zip_ext . '</br>' . $phone . '</br>' . $ext; ?>
                                                </td>
                                                <td width="97" align="center" valign="middle" class="brdr_1">
                                                    <a href="edit_address_service.php?id=<?php
        echo $id;
?>"><img src="admin/images/edit.png" alt="Edit Shipping Address" title="Edit Shipping Address" width="22" height="22" />
                                                    </a>&nbsp;&nbsp;
                                                    <a href="addressbook.php?delete_id=<?php
        echo $id;
?>" onclick="return confirm('Are you sure?');"><img src="admin/images/del.png" alt="Delete Shipping Address" title="Delete Shipping Address" width="22" height="22" class="mar_lft" />
                                                    </a>
                                                </td>
                                            </tr>
                                            <?php $i++; } } ?> </table>
                ...
                <div class="footerSRwapper" style="margin:auto;height:61px;">
                    <div id="body_footer-inner" class="body_wrapper-inner">
                        <ul class="navigation footer">
                            <li><a href="#"><span>About SohoRepro</span></a>
                            </li>
                            <li><a href="#"><span>FAQs</span></a>
                            </li>
                            <li><a href="#"><span>Privacy Policy</span></a>
                            </li>
                            <li><a href="#"><span>Security</span></a>
                            </li>
    ...
    <ul style="z-index: 4; top: 0px; left: 0px; display: none;" aria-activedescendant="ui-active-menuitem" role="listbox" class="ui-autocomplete ui-menu ui-widget ui-widget-content ui-corner-all"></ul>
</body>
