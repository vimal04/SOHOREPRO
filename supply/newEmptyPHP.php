<div style="width:100%;float: left;font-weight: bold;">
                <span style="font-weight: bold;float: left;cursor: pointer;" id="address_city_span_<?php echo $_POST['shipping_id_rp']; ?>" onclick="return show_address_recipient_city('<?php echo $_POST['shipping_id_rp']; ?>');"><?php echo $address_book[0]['city']; ?>,&nbsp;</span>
                <input style="display: none;float: left;width: 65px;" type="text" id="address_city_<?php echo $_POST['shipping_id_rp']; ?>" value="<?php echo $address_book[0]['city']; ?>" />
