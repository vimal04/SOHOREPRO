...
$Orders = getClosedOrdersAll($_REQUEST['sort']);
$rows = count(ClosedOrdersCount());
                                ...
                                <table width="759" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <td>
                                            ...
                                            if ($_GET['delete_id']) {
                                                ...
                                                if ($result == "success_del") {
                                                    ...
                                                    <script>setTimeout("location.href=\'supply_closed_order.php?ord_id=<?php echo $delete_id; ?>&ord_id=<?php echo $ord_id; ?>\'", 1000);</script>
                                                    <?php
                                            ...
                                            if ($result == "success_tax") {
                                                ...
                                                <script>setTimeout("location.href=\'supply_closed_order.php\'", 1000);</script>
                                                <?php
                                    ...
                                    <tr>
                                        <td align="left" valign="top"><table width="759" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td width="258" valign="middle" height="28" bgcolor="#f99b3e" align="center" class="td_brdr"><a style="text-decoration: none; color: #fff;" href="supply_closed_order.php?sort=<?php echo $sort_jrn; ?>">ORDER NUMBER&nbsp;<img src="images/<?php echo $sort_jrn_img; ?>.png"  alt="" width="10px" height="5px"/></a></td>
                                                    <td width="120" height="28" align="center" valign="middle" class="td_brdr" bgcolor="#f99b3e"><a style="text-decoration: none; color: #fff;" href="supply_closed_order.php?sort=<?php echo $sort_date; ?>">DATE &nbsp;<img src="images/<?php echo $sort_date_img; ?>.png"  alt="" width="10px" height="5px"/></a></td>                
                                                    <td width="189" height="28" align="center" valign="middle" class="td_brdr" bgcolor="#f99b3e"><a style="text-decoration: none; color: #fff;" href="supply_closed_order.php?sort=<?php echo $sort_prc; ?>">Customer&nbsp;<img src="images/<?php echo $sort_prc_img; ?>.png"  alt="" width="10px" height="5px"/></a></td>
                                                    <td width="258" valign="middle" height="28" bgcolor="#f99b3e" align="center" class="td_brdr"><a style="text-decoration: none; color: #fff;" href="supply_closed_order.php?sort=<?php echo $sort_jrn; ?>">JOB REFERENCE&nbsp;<img src="images/<?php echo $sort_jrn_img; ?>.png"  alt="" width="10px" height="5px"/></a></td>      
                                                    <td width="258" valign="middle" height="28" bgcolor="#f99b3e" align="center" class="td_brdr"><a style="text-decoration: none; color: #fff;" href="supply_closed_order.php?sort=<?php echo $sort_jrn; ?>">INVOICE FREQUENCY&nbsp;<img src="images/<?php echo $sort_jrn_img; ?>.png"  alt="" width="10px" height="5px"/></a></td>     
                                                </tr>
                                                <?php
                                                $i = 1;
                                                if (count($Orders) > 0) {
...
<!--                                                                            <td colspan="6">
                        ...
                        <tr align="right">
                            <td><?php echo Paginations($limit, $page, 'supply_closed_order.php?page=', $rows); ?></td>
                        </tr>
                    </table></td>
            </tr>
        </table></td>
