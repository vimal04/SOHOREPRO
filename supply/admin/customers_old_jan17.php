                                                ...
                                                if ($_REQUEST['search_cus'] != '') {
                                                    ...
                                                    <table width="759" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            ...
                                                            <td align="center" valign="middle" class="td_brdr" bgcolor="#f99b3e">TYPE</td>
                                                        ...
                                                        if (count($users_search) > 0) {
                                                            ...
                                                            foreach ($users_search as $Prod) {
                                                                ...
                                                                <tr class="trigger" id="<?php echo $Prod['comp_id']; ?>">
                                                                    ...
                                                                    <td width="10" align="center" valign="middle" bgcolor="<?php echo $rowColor; ?>" id="account_type_tr_<?php echo $cumpony_id; ?>"  class="pad_btm"><?php echo $cus_type; ?></td>
                                                                    <?php if ($_SESSION['admin_user_type'] == '1') { ?>
                                                                        <td width="80"  align="center" valign="middle" bgcolor="<?php echo $rowColor1; ?>" class="pad_btm">
...
<!--                                                                        <label style="font-weight: bold;">E-Billing:</label>        
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <span class="acc_email_head_inline_span_<?php echo $cumpony_id; ?>"><strong>Account Email :</strong></span> 
                                                                    ...
                                                                    <td align="left" width="30%" class="inf">
                                                                        <div style="padding-bottom:10px;padding-top: 10px;"><b>Invoicing:</b> Mail <input type="checkbox"> Print <input type="checkbox"> Both <input type="checkbox"></div>
                                                                        <div style="width: 100%;float: left;margin-bottom: 3px;"> 
                                                                            <ul>
                                                                                <li>
                                                                                    ...
                                                                                    <select name="invoice_freq" class="invoice_freq_type" id="invoice_freq_<?php echo $cumpony_id; ?>" onchange="return set_invoice_type('<?php echo $cumpony_id; ?>');">                                                                                        
                                                                                ...
                                                                                <td width="40%" class="inf">
                                                                                       <table border="0"> <?php //print_r($Prod);?>
                                                                                           <tr><td>
                                                                                                   ...
                                                                                                   <span style="cursor: pointer; min-width: 125px; min-height: 22px; display: inline-block;" class="acc_name_inline acc_name_inline_span_<?php echo $cumpony_id; ?>" id="<?php echo $cumpony_id; ?>"><?php echo $Prod['comp_contact_name'];?></span>
            ...
            <!--                                                                                            <span class="acc-spl click_close_special_<?php //echo $cumpony_id;      ?>" id="<?php //echo $cumpony_id;      ?>" style="cursor: pointer;">Click Here to load the Special Price List..</span>
                                    ...
                                    ?>
                                        ...
                                        <table width="800" border="0" cellspacing="0" cellpadding="0" >
                                            <tr>
                                                <td colspan="4" style="border-top: 1px solid #cecece;border-left: 1px solid #cecece;border-right: 1px solid #cecece; padding: 10px;text-transform: uppercase;font-size: 16px;">                                                  
                                                    <?php
                                                    if($_GET['admin_added'] == '1'){
                                                        echo 'Account Customers';
                                                    }elseif ($_GET['admin_added'] == '2') {
                                                        echo 'Cash Customers';    
                                                    }elseif ($_GET['cus_type_fil'] == '3') {
                                                        echo 'Cash Exempt Customer';      
                                                    }
                                                    ?>
                                                </td>
                                            </tr>
...
<span style="font-weight: bold;">Cust. Type :</span>
                                                                    ...
                                                                    <td><span class="acc_email_head_inline_span_<?php echo $cumpony_id; ?>"><strong>Account Email :</strong></span> 
                                                                                                   <span style="cursor: pointer; min-width: 125px; min-height: 22px; display: inline-block;" class="acc_email_inline acc_email_inline_span_<?php echo $cumpony_id; ?>" id="<?php echo $cumpony_id; ?>"><?php echo $Prod['comp_contact_email'];?></span>
                                                                                               <input style="width: 120px;" type="text" class="none acc_email_inline_txt_<?php echo $cumpony_id; ?>" id="acc_email_inline_txt_<?php echo $cumpony_id; ?>" value="<?php echo $Prod['comp_contact_email'];?>" />
                                                                                    <div style="float:left; margin:0 4px"><img src="images/like_icon.png" style="margin-top:-3px;display: none;" alt="Update" title="Update" width="22" height="22" class="acc_email_update acc_email_update_<?php echo $cumpony_id; ?>" id="<?php echo $cumpony_id; ?>" /></div>
                                                                                    <div style="float:left;  margin:0 4px"><img src="images/cancel_icon.png"  style="margin-top:-4px;display: none;"  alt="Cancel" title="Cancel" width="22" height="22" class="acc_email_cancel acc_email_cancel_<?php echo $cumpony_id; ?>" id="<?php echo $cumpony_id; ?>" /></div>
                                        ...
                                        <table width="800" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            if (count($users) > 0) {
                                                ...
                                                foreach ($users as $Prod) {
                                                    ...
                                                    $deleivery_address = ShippingAddressAllInfo($cumpony_id);
                                                    $deleivery_state = ($deleivery_address[0]['state'] != '') ? $deleivery_address[0]['state'] : '---';
                                                    //$cus_type = ($Prod['cus_type'] == '1') ? 'ACCOUNT' : 'CASH';
                                                    if($Prod['cus_type'] == '1'){
                                                        $cus_type = 'ACCOUNT';
                                                    }elseif($Prod['cus_type'] == '2'){
                                                        $cus_type = 'CASH';
                                                    ...
                                                    <tr class="trigger" id="<?php echo $Prod['comp_id']; ?>">
                                                        ...
                                                        <td width="100" align="center" valign="middle" bgcolor="<?php echo $rowColor; ?>"  class="pad_btm"><span class="company_name_<?php echo $cumpony_id; ?>"><?php echo $company_name; ?></span></td>                                                                
                                                        <td width="10" align="center" valign="middle" bgcolor="<?php echo $rowColor1; ?>" id="account_type_tr_<?php echo $cumpony_id; ?>"  class="pad_btm"><?php echo $cus_type; ?></td>
                                                        <?php if ($_SESSION['admin_user_type'] == '1') { ?>
 ...
 function filter_by_type_change()
    {
        ...
        if(filter_type == 'type_1'){
        window.location = "customers.php?cus_type_fil=1&admin_added=1";
        }else if(filter_type == 'type_2'){
        window.location = "customers.php?cus_type_fil=1&admin_added=2";      
        }else if(filter_type == 'type_3'){
        window.location = "customers.php?cus_type_fil=1&admin_added=3";
        }else{
...
//     }
    ...
    function e_billing_active(COMP_ID)
    {
        var e_billing       = document.getElementById("e_billing_"+COMP_ID).checked;
        var e_billing_val   =   (e_billing == true) ? "1" : "0";
        $.ajax
               ({
                   type: "POST",
                   url: "e_billing_active.php",
                   data: "e_billing_val="+encodeURIComponent(e_billing_val)+"&comp_id="+COMP_ID,
                   beforeSend: loadStart,
                   complete: loadStop,
                   success: function(option)
                   {
                       //$("#account_type_tr_"+COMP_ID).html(option);
                   }
               }); 
        
    }
    
    function change_account_type(COMP_ID)
    {
        var account_type      = $("#account_type_"+COMP_ID).val();
        var account_type_html = $("#account_type_"+COMP_ID).html();
        if(COMP_ID != ''){
        $.ajax
               ({
                   type: "POST",
                   url: "get_child.php",
                   data: "account_type_customer="+encodeURIComponent(account_type)+"&comp_id="+COMP_ID,
                   beforeSend: loadStart,
                   complete: loadStop,
                   success: function(option)
                   {
