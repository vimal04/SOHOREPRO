...
if(isset($_POST['comp_id']) && $_POST['comp_id'] != '')
{
    ...
    $cus_status         = ($type == '1') ? '<span style="color:green;font-size: 13px;">This user as a admin manager</span>' : '<span style="color:red;font-size: 13px;">This user not a admin manager</span>';
    echo $cus_status.'~';
}
?>
