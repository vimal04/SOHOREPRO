...
function getProducts($sorting,$start,$limit) {    
    if($sorting == 'pna'){
    $select_products = "SELECT * FROM sohorepro_products WHERE speciality = '0' ORDER BY product_name ASC LIMIT $start, $limit";  
    }elseif ($sorting == 'pnd') {
    $select_products = "SELECT * FROM sohorepro_products WHERE speciality = '0' ORDER BY product_name DESC LIMIT $start, $limit";      
    }elseif ($sorting == 'psa') {
    $select_products = "SELECT * FROM sohorepro_products WHERE speciality = '0' ORDER BY sku_id ASC LIMIT $start, $limit";      
    }elseif ($sorting == 'psd') {
    $select_products = "SELECT * FROM sohorepro_products WHERE speciality = '0' ORDER BY sku_id DESC LIMIT $start, $limit";      
    }elseif ($sorting == 'ppa') {
    $select_products = "SELECT * FROM sohorepro_products WHERE speciality = '0' ORDER BY price ASC LIMIT $start, $limit";      
    }elseif ($sorting == 'ppd') {
    $select_products = "SELECT * FROM sohorepro_products WHERE speciality = '0' ORDER BY price DESC LIMIT $start, $limit";      
    }  else {
    $select_products = "SELECT * FROM sohorepro_products WHERE speciality = '0' ORDER BY sku_id ASC LIMIT $start, $limit";   
    }  
...
function ProductsCount() {    
    $select_products = "SELECT * FROM sohorepro_products WHERE speciality = '0'"; 
    $products = mysql_query($select_products);
    while ($object = mysql_fetch_assoc($products)):
        $value[] = $object;
    endwhile;
...
function SpecialtyProducts() {    
    $select_products = "SELECT * FROM sohorepro_products WHERE move = '1' ORDER BY id DESC"; 
    $products = mysql_query($select_products);
    while ($object = mysql_fetch_assoc($products)):
        $value[] = $object;
    endwhile;
...
function getProductsFilter($su_file_id,$c_fil_id,$sc_fil_id,$start,$limit) {
    ...
    $select_products = "SELECT * FROM sohorepro_products WHERE supercategory_id = '".$su_file_id."' AND speciality = '0' ORDER BY sort ASC LIMIT $start, $limit ";  
    } elseif(($su_file_id != '0') && ($c_fil_id != '0') && ($sc_fil_id == '0')) {
    $select_products = "SELECT * FROM sohorepro_products WHERE supercategory_id = '".$su_file_id."' AND speciality = '0' AND category_id = '".$c_fil_id."' ORDER BY sort ASC";
    } else {
    $select_products = "SELECT * FROM sohorepro_products WHERE supercategory_id = '".$su_file_id."' AND speciality = '0' AND category_id = '".$c_fil_id."' AND subcategory_id = '".$sc_fil_id."' ORDER BY sort ASC LIMIT $start, $limit";    
    }    
    $products = mysql_query($select_products);
    while ($object = mysql_fetch_assoc($products)):
        $value[] = $object;
...
function getProductsFilterS($search_val,$start,$limit) {
    ...
    $select_products = "SELECT * FROM `sohorepro_products` WHERE `product_name` LIKE '%$val%' AND speciality = '0' LIMIT $start, $limit ";
    $products = mysql_query($select_products);
    while ($object = mysql_fetch_assoc($products)):
        $value[] = $object;
    endwhile;
...
function getActiveEmailPAC() {
    $select_products = "SELECT * FROM sohorepro_email WHERE status = '1' AND PAC = '1'";
    $products = mysql_query($select_products);
    while ($object = mysql_fetch_assoc($products)):
        $value[] = $object;
    endwhile;
...
function getsuper_subcatProducts($c_id,$s_id,$fav_arr) {
    $no_product  = "AND id NOT IN(".$fav_arr.")";
...
function FilterByCustomer($filter_by, $admin_added, $start, $limit) {
    if($admin_added != ''){
    $select_users = "SELECT * FROM sohorepro_company WHERE archive = '0' AND cus_type = '".$admin_added."' ORDER BY comp_id ASC LIMIT $start, $limit";
    }else{
...
function CheckStatusEmailSettingsService($id, $service_items) {
    $select_number = "SELECT * FROM sohorepro_email WHERE id = '".$id."'";
    $number = mysql_query($select_number);
    $object = mysql_fetch_assoc($number);
    $catg = $object["$service_items"]; 
    return $catg;
}
...
function SetsForId($id) {
    $select_fav = "SELECT * FROM sohorepro_plotting_set WHERE id = '".$id."' " ;
    $details       = mysql_query($select_fav);
    while ($object = mysql_fetch_assoc($details)):
        $value[] = $object;
    endwhile;
...
function getCompContName($id) {
    $select_company = "SELECT comp_contact_name FROM sohorepro_company WHERE comp_id = '".$id."'";
    $company = mysql_query($select_company);
    $object = mysql_fetch_assoc($company);
    $catg = $object['comp_contact_name']; 
    return $catg;
}

function getCompContFLName($id) {
    $select_company = "SELECT * FROM sohorepro_customers WHERE cus_compname = '".$id."'";
    $company = mysql_query($select_company);
    $object = mysql_fetch_assoc($company);
    $catg = $object['cus_fname'].'&nbsp;'.$object['cus_lname']; 
    return $catg;
}

function getCompContMail($id) {
    $select_company = "SELECT comp_contact_email FROM sohorepro_company WHERE comp_id = '".$id."'";
    $company = mysql_query($select_company);
    $object = mysql_fetch_assoc($company);
    $catg = $object['comp_contact_email']; 
...
function ServicesItems() {
    $select_products = "SELECT * FROM sohorepro_services_items";
    $products = mysql_query($select_products);
    while ($object = mysql_fetch_assoc($products)):
        $value[] = $object;
    endwhile;
...
function getCusType($id) {
    $select_company = "SELECT cus_type FROM sohorepro_company WHERE comp_id = '".$id."'";
    $company = mysql_query($select_company);
    $object = mysql_fetch_assoc($company);
    $catg = $object['cus_type']; 
    return $catg;
}

function OffsetData($id) {
    $select_products = "SELECT *  FROM sohorepro_offset_order WHERE id = '".$id."'";
    $products = mysql_query($select_products);
    while ($object = mysql_fetch_assoc($products)):
        $value[] = $object;
    endwhile;
...
function OffsetFiles($id) {
    $select_products = "SELECT *  FROM sohorepro_upload_files_set_off_set WHERE order_id = '".$id."'";
    $products = mysql_query($select_products);
    while ($object = mysql_fetch_assoc($products)):
        $value[] = $object;
    endwhile;
...
function getActiveOffset() {
    $select_products = "SELECT * FROM sohorepro_email WHERE status = '1' AND OFP = '1'";
    $products = mysql_query($select_products);
    while ($object = mysql_fetch_assoc($products)):
        $value[] = $object;
    endwhile;
...
function CheckSpecialityStatus($id){
    $select_products = "SELECT * FROM sohorepro_products WHERE id = '".$id."'"; 
    $products = mysql_query($select_products);
    while ($object = mysql_fetch_assoc($products)):
        $value[] = $object;
...
function EnteredLFPPrimary($comp_id, $user_id) {
    $select_fav = "SELECT * FROM sohorepro_service_lfp WHERE company_id = '".$comp_id."' AND user_id = '".$user_id."' AND order_id = '0'" ;
    $details       = mysql_query($select_fav);
    while ($object = mysql_fetch_assoc($details)):
        $value[] = $object;
    endwhile;
...
function CheckFavExistCus($comp_id,$c_id, $s_id) {
    $select_fav = "SELECT * FROM sohorepro_favorites WHERE comp_id = '".$comp_id."' AND supercategory_id = '".$c_id."' AND category_id = '".$s_id."' " ;
...
function CheckProdComp($c_id, $s_id, $prod_id) {
    $select_fav = "SELECT * FROM sohorepro_favorites WHERE supercategory_id = '".$c_id."' AND category_id = '".$s_id."' AND product_id = '".$prod_id."' " ;
//    $select_fav = "SELECT * FROM sohorepro_favorites" ;
    $details       = mysql_query($select_fav);
    while ($object = mysql_fetch_assoc($details)):
        $value[] = $object;
...
function ExistFavTbl($prod_id, $comp_id) {
    $select_fav = "SELECT * FROM sohorepro_favorites WHERE comp_id = '".$comp_id."' AND product_id = '".$prod_id."' " ;
//    $select_fav = "SELECT * FROM sohorepro_favorites" ;
    $details       = mysql_query($select_fav);
    while ($object = mysql_fetch_assoc($details)):
        $value[] = $object;
...
function CheckFavExistCusJK($c_id, $s_id) {
    $select_fav = "SELECT * FROM sohorepro_favorites WHERE supercategory_id = '".$c_id."' AND category_id = '".$s_id."' " ;
//    $select_fav = "SELECT * FROM sohorepro_favorites" ;
    $details       = mysql_query($select_fav);
    while ($object = mysql_fetch_assoc($details)):
        $value[] = $object;
...
function CheckAllFavExist($comp_id,$product_id) {
    $select_fav = "SELECT * FROM sohorepro_favorites WHERE comp_id = '".$comp_id."' AND product_id = '".$product_id."' " ;
//    $select_fav = "SELECT * FROM sohorepro_favorites" ;
    $details       = mysql_query($select_fav);
    while ($object = mysql_fetch_assoc($details)):
...
function GetCompIdFav($product_id) {
    $select_fav = "SELECT * FROM sohorepro_favorites WHERE product_id = '".$product_id."'" ;
    $details       = mysql_query($select_fav);
    while ($object = mysql_fetch_assoc($details)):
        $value[] = $object;
    endwhile;
...
function CompanyExistSplty($comp_id, $product_id) {
    $select_fav = "SELECT * FROM sohorepro_favorites WHERE comp_id = '".$comp_id."' AND product_id = '".$product_id."'" ;
    $details       = mysql_query($select_fav);
    while ($object = mysql_fetch_assoc($details)):
        $value[] = $object;
...
function CompanyExistSpltyNotN($comp_id, $product_id) {
    $select_fav = "SELECT * FROM sohorepro_favorites WHERE comp_id NOT IN(".$comp_id.") AND product_id = '".$product_id."'" ;
    $details       = mysql_query($select_fav);
    while ($object = mysql_fetch_assoc($details)):
        $value[] = $object;
    endwhile;
