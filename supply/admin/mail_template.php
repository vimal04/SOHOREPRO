...
function AdminAlertActive($reg_compname, $reg_contactname) {
    $message_admin = '<html>';
    $message_admin .='<head>';
    ...
    $message_admin .='</tr>';
    $message_admin .='<tr>';
    $message_admin .='<td><a href="http://supply.sohorepro.com/admin/new_accounts.php" target="_blank">http://supply.sohorepro.com/admin/new_accounts.php</a></td>';
    $message_admin .='</tr>';
    $message_admin .='</table>';
    $message_admin .='</td>';
    $message_admin .='</tr>';
