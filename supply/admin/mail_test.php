...
$message .= '<td><span style="font-weight:bold;font-size: 21px">Order Completed: </span><span style="font-size: 21px">ORDER #' . $Order_number . '</span></td>';
$message .= '</tr>';
...
$message .= '<tr height="30px">';
$message .= '<td><span style="font-weight:bold;font-size: 21px">Customer Type:&nbsp;</span><span style="font-size: 21px">' . $cus_type . '</span></td>';
$message .= '</tr>';
