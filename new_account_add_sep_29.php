                                                                        ...
                                                                        return false;
                                                                                        ...
                                                                                        <form id="reg_form" name="reg_form" action="add_new_user.php" method="post" enctype="multipart/form-data" onsubmit="return validate()">
                                                                                            ...
                                                                                            <div style="width:700px; margin-left: 50px; margin-top: 10px; clear: both;">  
                                                                                                ...
                                                                                                <div class="label_regview"> Contact Email :</div> 
                                                                                                ...
                                                                                                <div class="label_regview"> Address1 :</div> 
<!--                                                                                                <textarea class="reginput comp_det_view" name="address1" id="address1" placeholder="Address1"></textarea>-->
                                                                                                <input type="text" class="reginput comp_det_view" name="address1" id="address1" placeholder="Address1" />
                                                                                                ...
                                                                                                <input intvalue="City" class="required reginput comp_det_view" name="reg_busifax" id="reg_busifax" type="text" placeholder="Fax"/>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td align="center" colspan="2" style="border-top: 1px solid #ddd;" valign="middle">Upload the filled form: 
                                                                                                                ...
                                                                                                                <div class="btn_choose">
                                                                                                                    <input type="file" id="exempt_form" class="choose">
                                                                                                                </div>
                                                                                                            </td>            
                                                                                                        </tr>
                                                                                                    </table>     
