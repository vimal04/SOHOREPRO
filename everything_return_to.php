...
if ($_POST['everything_return_to'] == '1') {
    ...
    $address_book_label = $_POST['address_book_lable'];
    ...
    <div style="border: 1px #F99B3E solid;margin-bottom: 20px;padding-bottom: 20px;width: 100%;float: left;">
        <div style="width: 100%;float: left;margin-top: 10px;">
            <div style="float: left;width: 48%;margin-left: 22px;font-weight: bold;">SEND EVERYTHING TO <?php echo $address_book_label; ?></div>
                        ...
                        <!-- Options Details Start -->
                         <?php
                            ...
                            foreach ($original_service_lfp as $entered) {
                                ...
                                if (($entered['special_inc'] != '') OR  ($entered['size'] == 'CUSTOM') OR ($entered['output'] == 'BOTH') OR ($entered['schedule_pickup'] != '0') OR ($entered['drop_off'] != '0')){
                                ?>
            ...
            <div style="width: 95%;float: left;margin-left: 25px;">                    
                    <div style="width: 100%;float: left;">                            
                        ...
                        <?php
                            ...
                            foreach ($original_service_fap as $key=> $entered) { $key++;
                     
                                
                                if (($entered['special_instruction'] != '') OR  ($entered['size'] == 'Custom') OR ($entered['output'] == 'Both') OR ($entered['pick_up'] != '0') OR ($entered['dropoff_val'] != '0')){
                                ?>
                                
                    <div style="float:left;width: 100%;font-weight: bold;color: #000;margin-top: 7px;"> OPTION <?php echo $key; ?></div>
                    <div style="width: 98%;float: left;border: 1px solid #F99B3E;padding: 5px;">   
                        <?php
                        if ($entered['size'] == 'Custom') {
                            ?>
