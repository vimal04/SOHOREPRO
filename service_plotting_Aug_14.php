...
<!-----TABLE END--->     
 ...
 <script>
  ...
  {   
    ...
    var date_for_alt_val    = (date_for_alt != '') ? date_for_alt : '0';
        
    var time_for_alt        =  document.getElementById("time_for_alt").value;
    var time_for_alt_val    =  (time_for_alt != '') ? time_for_alt : '0';
    
    var drop_chk_0          =   document.getElementById("drop_val").value;
    var drop_chk_1          =   document.getElementById("drop_val_1").value;
    var drop_chk            =   document.getElementById("drop_val").checked;
    var drop_off_select_val =   document.getElementById("drop_off_select_val").value;
    
    if(drop_off_select_val == '1'){
    var drop_val            =   (drop_chk == true) ? drop_chk_0 : drop_chk_1;
    }else{
    var drop_val            =   '0';
    }
