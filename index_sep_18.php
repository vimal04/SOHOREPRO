...
<div id="supply_hdr">
 ...
 <input aria-haspopup="true" aria-autocomplete="list" role="textbox" autocomplete="off" class="ui-autocomplete-input dec" style="padding:3px;" name="jobref" id="jobref" type="text" value="<?php if($_GET['refere'] != ''){echo $_GET['refere'];} ?>" onblur="return dummy_reference();" />
 </div> 
 ...
 <div class="inPageCartBlock" style="color:#5C5C5C;font-weight:bold;font-size:18px;padding-right:0px;">
     ...
     <div style="float: right;">         
         <input type="text" class="dec_search" name="search_val" value="<?php echo htmlentities($_POST['search_val']); ?>" placeholder="Search Products" onfocus="this.placeholder='';" autocomplete="off" id="search_val"/>
        <input type="submit" class="button_search" onclick="return search_test_r();" value="Search" />        
    </div> 
    </form>        
 </div>
 <!-- Header End -->
 ...
 <div class="result_section">
     ...
     foreach ($search as $src){
        ...
        <tr>
            ...
            <td align="center" bgcolor="<?php echo $rowColor; ?>" style="width:50px"><div class="btn_addcart"><img src="images/add_cart_bg.png" onclick="return add_cart('<?php echo $src['id']; ?>','<?php echo $prd_id; ?>');" class="click_<?php echo $src['id']; ?>" id="click_<?php echo $src['id']; ?>" style="cursor: pointer;" /><img class="click_i_<?php echo $src['id']; ?>" src="images/add_to_cart.png" style="display: none;"/></div></td>             
                <input type="hidden" id="product_id" name="product_id[]" value="<?php echo $src['id']; ?>" />
                <input type="hidden" id="product_name" name="product_name[]" value="<?php echo mysql_escape_string(htmlentities(stripslashes($src['product_name']), ENT_QUOTES)); ?>" />                
         </tr>
         <?php
         $i++;
         }
 ...
 <div id="login_window">    	
        ...
        <div id="popup_content" class="checkout_login"> <!--your content start-->
                ...
                <ul>
                    ...
                    <li > <a href="sign_up" class="account_link">CREATE AN ACCOUNT</a> | <span onclick="return goto_new_checkout();" class="pointer">GUEST CHECKOUT</span></li>
                </ul>
                ...
                type: "POST",
                    ...
                    success: function(option)
                    {
                      if(option = '1'){ 
                       ...
                       document.getElementById("alert_msg").innerHTML = "User name password mismatch";
                       return false;
                      }
                    }
             });
